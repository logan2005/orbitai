...
export const SECTIONS: SectionData[] = [
  {
    ...
    description: "Every campus consumes power constantly — lights, fans, air conditioning, systems — even when no one is present. Most of this energy loss goes unnoticed, silently increasing costs and carbon footprint.",
  ...
  },
  {
    ...
    description: "Solar panels come into view as a natural solution — capturing abundant sunlight and converting it into usable power. This is the foundation of a smarter, cleaner campus ecosystem.",
    visualType: 'solar-install',
    highlights: ["Renewable energy source", "Designed for campus scale", "Grid-connected efficiency"],
    layout: 'left'
  },
  {
    id: 'scene-3',
  ...
  },
  {
    ...
    description: "ORBIT AI now looks across the campus, identifying which rooms are occupied and which are empty — without knowing who anyone is. Just awareness, not identity.",
  ...
  },
  {
    ...
    description: "Every decision made by ORBIT AI is logged and visible. This ensures accountability, trust, and complete transparency in how the campus operates.",
  ...
  {
    id: 'scene-8',
    title: "Watching Over the Campus",
    subtitle: "Continuous Situational Awareness",
    description: "Cameras quietly observe campus spaces — not to identify individuals, but to understand movement, density, and flow. Safety begins with awareness.",
    visualType: 'student-monitor',
    highlights: ["Campus-wide monitoring", "Movement patterns", "Privacy-first design"],
    layout: 'left'
  },
  {
    id: 'scene-9',
  ...
  },
  {
    ...
    description: "Litter, spills, and hygiene concerns are detected automatically, helping maintain clean campus environments without constant inspections.",
  ...
  },
  {
    ...
    subtitle: "A Campus That Self-Manages",
    description: "Energy, safety, hygiene, and operations work together seamlessly. The campus runs smoothly, intelligently, and efficiently.",
  ...
  },
  {
    ...
    description: "ORBIT AI is not just software — it's the invisible intelligence that powers smarter, safer, and more sustainable campuses.",
    visualType: 'unified',
    highlights: ["One unified platform", "Scalable for the future", "Built for real campuses"],
    layout: 'left'
  }
];
